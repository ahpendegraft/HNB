...
The BhGLM package can be accessed at <https://github.com/nyiuab/BhGLM>. You can install the package with `devtools` package as
...
After downloading BhGLM_1.1.0.zip, the source code can be installed on your local machine.
