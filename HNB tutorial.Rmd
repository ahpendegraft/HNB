...
The BhGLM package can be accessed at <https://github.com/nyiuab/BhGLM>.  After downloading BhGLM_1.1.0.zip, the source code can be installed on your local machine.
